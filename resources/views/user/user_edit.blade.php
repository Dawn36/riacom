<form id="add_form" class="form" method="POST" action="{{ route('user.update',$user->id) }}">
    ...
    <div class="py-10 px-7 px-lg-10">
        ...
        <div class="fv-row mb-5">
            ...
            <input type="text" value="{{ $user->name }}" class="form-control form-control-solid" placeholder="Enter Full name"
                name="name" />
        </div>
        <div class="fv-row mb-5">
            <label class="fs-6 fw-semibold mb-2">Email</label>
            <input type="text" value="{{ $user->email }}" class="form-control form-control-solid" placeholder="Enter Email" name="email" />
        </div>
        <div class="fv-row mb-5">
            <label class="fs-6 fw-semibold mb-2">Phone</label>
            <input type="text" class="form-control form-control-solid kt_inputmask_2" placeholder="Enter phone number"
                name="phone_number" value="{{ $user->phone_number }}" />
        </div>
        <div class="fv-row mb-5">
            <label class="fs-6 fw-semibold mb-2">Password</label>
            <input type="password" class="form-control form-control-solid" placeholder="Enter password number"
                name="password" />
        </div>
    </div>
