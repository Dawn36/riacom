                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-toolbar">
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                <button type="button" class="btn btn-primary" onclick="openModalBox('modal_large','{{ route('user.create') }}','Add User','user')">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5 kt_datatable_example_1" id="kt_datatable_example_1">
                            ...
                            <tbody class="text-gray-600 fw-semibold">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="badge badge-light-primary fw-bold">User</div>
                                    </td>
                                    <td>{{ $item->created_at }}</td>
                                    <td class="text-end nowrap">
                                        <button class="btn btn-icon btn-sm btn-color-gray-400 btn-active-icon-primary" onclick="openModalBox('modal_large','{{ route('user.edit',$item->id) }}','Edit User')">
                                            <i class="ki-duotone ki-pencil fs-1" data-bs-toggle="tooltip" title="Edit">
                                                <span class="path1"></span>
                                                <span class="path2"></span>
                                            </i>
                                        </button>
                                        <button type="button" class="btn btn-icon btn-sm btn-color-gray-400 btn-active-icon-danger " onclick="deleteSweerAlert('This user has been deleted.','{{ route('user.destroy',$item->id) }}','{{route('user.index')}}')" data-bs-toggle="tooltip" title="Delete" data-bs-placement="top">
