            ...
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack flex-wrap">
                <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                    <div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
                        <h1 class="page-heading d-flex flex-column justify-content-center text-dark fw-bold fs-3 m-0">{{ __('admin.Users List') }}</h1>
                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-toolbar">
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                <button type="button" class="btn btn-primary" onclick="openModalBox('modal_large','{{ route('user.create') }}','{{ __('admin.Add User') }}','user')">
                                    <i class="ki-outline ki-plus fs-2"></i>{{ __('admin.Add User') }}</button>
                            </div>
                        </div>
                    </div>
                    <!--end::Card header-->
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5 kt_datatable_example_1" id="kt_datatable_example_1">
                            ...
                            <tbody class="text-gray-600 fw-semibold">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="badge badge-light-primary fw-bold">{{ __('admin.User') }}</div>
                                    </td>
                                    ...
                                    <td class="text-end nowrap">
                                        ...
                                        <button type="button" class="btn btn-icon btn-sm btn-color-gray-400 btn-active-icon-danger " onclick="deleteSweerAlert('{{ __('admin.This user has been deleted') }}.','{{ route('user.destroy',$item->id) }}','{{route('user.index')}}')" data-bs-toggle="tooltip" title="{{ __('admin.Delete') }}" data-bs-placement="top">
