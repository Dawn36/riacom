    ...
    <div class="scroll-y py-10 px-7 px-lg-10" id="modal_large" data-kt-scroll="true"
        ...
        <div class="row g-5">
            ...
            <div class="col-12 col-md-6 col-lg-4">
                ...
                <select name="tension" class="form-select form-select-solid "
                    data-dropdown-parent="#modal_large" data-control="select2" data-close-on-select="true"
            ...
            <div class="col-12 col-md-6 col-lg-4">
                ...
                <select name="power" class="form-select form-select-solid"
                    data-dropdown-parent="#modal_large" data-control="select2" data-close-on-select="true"
            ...
            <div class="col-12 col-md-6 col-lg-4">
                ...
                <select name="cicle" class="form-select form-select-solid "
                    data-dropdown-parent="#modal_large" data-control="select2" data-close-on-select="true"
            ...
            <div class="col-12 col-md-6 col-lg-4">
                ...
                <select name="tariff" class="form-select form-select-solid"
                    data-dropdown-parent="#modal_large" data-control="select2" data-close-on-select="true"
            ...
            <div class="col-12 col-md-6 col-lg-4">
                ...
                <select name="reception_phase" class="form-select form-select-solid "
                    data-dropdown-parent="#modal_large" data-control="select2" data-close-on-select="true"
            ...
            <div class="col-12 col-md-6 col-lg-4">
                ...
                <select name="gas_pressure" class="form-select form-select-solid "
                    data-dropdown-parent="#modal_large" data-control="select2" data-close-on-select="true"
            ...
            <div class="col-12 col-md-6 col-lg-4">
                ...
                <select name="gas_scalation" class="form-select form-select-solid"
                    data-dropdown-parent="#modal_large" data-control="select2" data-close-on-select="true"
            ...
            <div class="col-12 col-md-6 col-lg-4">
                ...
                <select name="gas_tariff" class="form-select form-select-solid"
                    data-dropdown-parent="#modal_large" data-control="select2" data-close-on-select="true"
            ...
            <div class="col-12 col-md-6 col-lg-4">
                ...
                <select name="energy_market" class="form-select form-select-solid "
                    data-dropdown-parent="#modal_large" data-control="select2" data-close-on-select="true"
            ...
            <div class="col-12 col-md-6 col-lg-4">
                ...
                <select name="gas_market" class="form-select form-select-solid"
                    data-dropdown-parent="#modal_large" data-control="select2" data-close-on-select="true"
