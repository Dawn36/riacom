<form id="add_form" class="form" method="POST" action="{{ route('provider.store') }}">
    ...
    <div class="py-10 px-7 px-lg-10">
        ...
        <div class="fv-row mb-5">
            ...
            <input type="text" class="form-control form-control-solid" placeholder="Enter Full name"
                name="name" />
        </div>
        <div class="fv-row mb-5">
        ...
        @if (Auth::user()->hasRole('admin'))
            <div class="fv-row mb-5">
                ...
                <select name="users[]" class="form-select form-select-solid js-example-basic-single"
                    data-control="select2" data-close-on-select="true" data-placeholder="Assign Users"
        ...
        <div class="fv-row mb-5">
            ...
            <input type="text" class="form-control form-control-solid kt_tagify_1"
                placeholder="Enter Type of Service" name="type_of_service" />
        </div>
    </div>
