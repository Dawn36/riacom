                                            ...
                                            <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                                <a>
                                                    <div class="symbol-label">
                                                        <img src="{{ asset($item->image) }}" alt="Softixs" class="w-100">
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="d-block">
                                                <a href="{{ route('provider.show',$item->id) }}" class="fw-bolder text-gray-800 text-hover-primary mb-1">{{ $item->name }}</a>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        ...
                                        <br>
                                        <a href="tel:{{ $item->phone }}" class="fw-normal text-gray-800 text-hover-primary mb-1">{{ $item->phone }}</a>
                                    </td>
                                    <td>
